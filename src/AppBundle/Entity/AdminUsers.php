<?php
// src/AppBundle/Entity/AdminUsers.php
...
* @ORM\Entity(repositoryClass="AppBundle\Repository\AdminUsersRepository")
*/
class AdminUsers
{
/**
 ...
 /**
  ...
  public function getKycStatus()
   ...
   public function setCustomerUsername($account_username)
    {
        return $this->account_username=$account_username;
    }

  public function setCustomerAccountKey($account_key)
    {
